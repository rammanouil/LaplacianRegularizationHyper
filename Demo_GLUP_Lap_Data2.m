...
image_X = grid_image_S2 ; % generate Data2 used in experiments
...
lambda_ = 10^-4; % [0.5*10^-4 10^-3 5*10^-3 0.01 0.05 0.1 0.3 0.5 1];
% for spatial regularization
lambda_TV_ = 0.005; %[0.5*10^-4 10^-3 5*10^-3 0.01 0.05 0.1 0.3 0.5 1];
...
% ---------------------------------------
dmin = 0.5; % maximum SQUARE distance between pixels
...
% for sparsity regularization
mu_ = 10^-4; % [0.5*10^-5 0.5*10^-4 10^-3 5*10^-3 0.01 0.05 0.1 0.3 0.5 1];
% for spatial regularization
mu_Lap_ = 1; % [0.5*10^-5 0.5*10^-4 10^-3 5*10^-3 0.01 0.05 0.1 0.3 0.5 1];
